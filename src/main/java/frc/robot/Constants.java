...
public final class Constants {
    ...
    public static final class IntakeConstants {
        ...
        public static final double MAX_VELOCITY_MPS_PP = 0; //pp path planner
        public static final double MAX_ACCELERATION_MPS_SQ_PP = 0; //pp path planner
        public static final double MAX_ANGULAR_VELOCITY_RPS_PP = 0; //pp path planner
        public static final double MAX_ANGULAR_ACCELERATION_RPS_SQ_PP = 0; //pp path planner
